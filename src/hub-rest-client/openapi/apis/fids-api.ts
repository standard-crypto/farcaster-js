 ...
 * @export
 */
export const FIDsApiAxiosParamCreator = function (
...
export const FIDsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async listFids(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FidsResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listFids(
        pageSize,
        reverse,
        pageToken,
        options
 ...
 * @export
 */
export const FIDsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    listFids(
      requestParameters: FIDsApiListFidsRequest = {},
      options?: AxiosRequestConfig
    ): AxiosPromise<FidsResponse> {
      return localVarFp
        .listFids(
...
export class FIDsApi extends BaseAPI {
  ...
  public listFids(
    ...
    return FIDsApiFp(this.configuration)
      .listFids(
        requestParameters.pageSize,
        requestParameters.reverse,
        requestParameters.pageToken,
