 ...
 * @export
 */
export const UsernamesApiAxiosParamCreator = function (
...
export const UsernamesApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    UsernamesApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Get an proof for a username by the Farcaster username
     ...
     * @throws {RequiredError}
     */
    async getUsernameProof(
      name: string,
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserNameProof>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getUsernameProof(name, options);
    ...
    async listUsernameProofsByFid(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<UsernameProofsResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listUsernameProofsByFid(fid, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
 ...
 * @export
 */
export const UsernamesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    getUsernameProof(
      requestParameters: UsernamesApiGetUsernameProofRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<UserNameProof> {
      return localVarFp
        .getUsernameProof(requestParameters.name, options)
    ...
    listUsernameProofsByFid(
      requestParameters: UsernamesApiListUsernameProofsByFidRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<UsernameProofsResponse> {
      return localVarFp
        .listUsernameProofsByFid(requestParameters.fid, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class UsernamesApi extends BaseAPI {
   ...
   */
  public getUsernameProof(
    requestParameters: UsernamesApiGetUsernameProofRequest,
    options?: AxiosRequestConfig
  ) {
    return UsernamesApiFp(this.configuration)
      .getUsernameProof(requestParameters.name, options)
   ...
   * @memberof UsernamesApi
   */
  public listUsernameProofsByFid(
    requestParameters: UsernamesApiListUsernameProofsByFidRequest,
    options?: AxiosRequestConfig
  ) {
    return UsernamesApiFp(this.configuration)
