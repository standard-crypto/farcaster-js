  ...
  return {
    ...
    async getInfo(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<HubInfoResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getInfo(
        dbstats,
        options
      );
...
export const InfoApiFactory = function (
  ...
  return {
     ...
     */
    getInfo(
      requestParameters: InfoApiGetInfoRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<HubInfoResponse> {
      return localVarFp
        .getInfo(requestParameters.dbstats, options)
