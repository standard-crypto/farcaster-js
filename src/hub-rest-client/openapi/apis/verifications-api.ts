...
export const VerificationsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    VerificationsApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Get a list of verifications provided by an FID
    ...
    async listVerificationsByFid(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListVerificationsByFid200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listVerificationsByFid(
          fid,
          address,
          pageSize,
          reverse,
...
export const VerificationsApiFactory = function (
  ...
  return {
    ...
    listVerificationsByFid(
      requestParameters: VerificationsApiListVerificationsByFidRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListVerificationsByFid200Response> {
      return localVarFp
        .listVerificationsByFid(
