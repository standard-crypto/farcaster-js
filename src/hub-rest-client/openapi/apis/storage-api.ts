  ...
  return {
    ...
    async getStorageLimitsByFid(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<StorageLimitsResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getStorageLimitsByFid(fid, options);
...
export const StorageApiFactory = function (
  ...
  return {
    ...
    getStorageLimitsByFid(
      requestParameters: StorageApiGetStorageLimitsByFidRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<StorageLimitsResponse> {
      return localVarFp
        .getStorageLimitsByFid(requestParameters.fid, options)
