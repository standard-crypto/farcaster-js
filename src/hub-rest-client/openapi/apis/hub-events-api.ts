 ...
 * @export
 */
export const HubEventsApiAxiosParamCreator = function (
...
export const HubEventsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    HubEventsApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Get an event by its ID
    ...
    async getEventById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<HubEvent>
    > {
 ...
 * @export
 */
export const HubEventsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    getEventById(
      requestParameters: HubEventsApiGetEventByIdRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<HubEvent> {
      return localVarFp
        .getEventById(requestParameters.eventId, options)
     ...
     */
    listEvents(
      requestParameters: HubEventsApiListEventsRequest = {},
      options?: AxiosRequestConfig
    ): AxiosPromise<ListEvents200Response> {
      return localVarFp
        .listEvents(requestParameters.fromEventId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class HubEventsApi extends BaseAPI {
  ...
  public getEventById(
    ...
    return HubEventsApiFp(this.configuration)
      .getEventById(requestParameters.eventId, options)
