...
[packages/farcaster-js-neynar/src/v1/openapi/generated/apis/cast-api.ts:38](https://github.com/standard-crypto/farcaster-js/blob/main/packages/farcaster-js-neynar/src/v1/openapi/generated/apis/cast-api.ts#L38)
...
| Name | Type |
| :------ | :------ |
| `allCastsInThread` | (`requestParameters`: [`CastApiAllCastsInThreadRequest`](../interfaces/v1.CastApiAllCastsInThreadRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`AllCastsInThreadResponse`\> |
| `cast` | (`requestParameters`: [`CastApiCastRequest`](../interfaces/v1.CastApiCastRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`CastResponse`\> |
| `casts` | (`requestParameters`: [`CastApiCastsRequest`](../interfaces/v1.CastApiCastsRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`CastsResponse`\> |
| `recentCasts` | (`requestParameters`: [`CastApiRecentCastsRequest`](../interfaces/v1.CastApiRecentCastsRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`RecentCastsResponse`\> |
...
| Name | Type |
| :------ | :------ |
| `allCastsInThread` | (`threadHash`: `string`, `viewerFid?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`AllCastsInThreadResponse`\>\> |
| `cast` | (`hash`: `string`, `viewerFid?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`CastResponse`\>\> |
| `casts` | (`fid`: `number`, `viewerFid?`: `number`, `parentUrl?`: `string`, `cursor?`: `string`, `limit?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`CastsResponse`\>\> |
| `recentCasts` | (`viewerFid?`: `number`, `cursor?`: `string`, `limit?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`RecentCastsResponse`\>\> |
...
| Name | Type |
| :------ | :------ |
| `followers` | (`requestParameters`: [`FollowsApiFollowersRequest`](../interfaces/v1.FollowsApiFollowersRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`FollowResponse`\> |
| `following` | (`requestParameters`: [`FollowsApiFollowingRequest`](../interfaces/v1.FollowsApiFollowingRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`FollowResponse`\> |
...
| Name | Type |
| :------ | :------ |
| `followers` | (`fid`: `number`, `viewerFid?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`FollowResponse`\>\> |
| `following` | (`fid`: `number`, `viewerFid?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`FollowResponse`\>\> |
...
| Name | Type |
| :------ | :------ |
| `mentionsAndReplies` | (`requestParameters`: [`NotificationsApiMentionsAndRepliesRequest`](../interfaces/v1.NotificationsApiMentionsAndRepliesRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`MentionsAndRepliesResponse`\> |
| `reactionsAndRecasts` | (`requestParameters`: [`NotificationsApiReactionsAndRecastsRequest`](../interfaces/v1.NotificationsApiReactionsAndRecastsRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`ReactionsAndRecastsResponse`\> |
...
| Name | Type |
| :------ | :------ |
| `mentionsAndReplies` | (`fid`: `number`, `viewerFid?`: `number`, `cursor?`: `string`, `limit?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`MentionsAndRepliesResponse`\>\> |
| `reactionsAndRecasts` | (`fid`: `number`, `viewerFid?`: `number`, `cursor?`: `string`, `limit?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`ReactionsAndRecastsResponse`\>\> |
...
| Name | Type |
| :------ | :------ |
| `castLikes` | (`requestParameters`: [`ReactionsApiCastLikesRequest`](../interfaces/v1.ReactionsApiCastLikesRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`CastLikesResponse`\> |
| `castReactions` | (`requestParameters`: [`ReactionsApiCastReactionsRequest`](../interfaces/v1.ReactionsApiCastReactionsRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`CastReactionsResponse`\> |
| `castRecasters` | (`requestParameters`: [`ReactionsApiCastRecastersRequest`](../interfaces/v1.ReactionsApiCastRecastersRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`CastRecasterResponse`\> |
...
| Name | Type |
| :------ | :------ |
| `castLikes` | (`castHash`: `string`, `viewerFid?`: `number`, `cursor?`: `string`, `limit?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`CastLikesResponse`\>\> |
| `castReactions` | (`castHash`: `string`, `viewerFid?`: `number`, `cursor?`: `string`, `limit?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`CastReactionsResponse`\>\> |
| `castRecasters` | (`castHash`: `string`, `viewerFid?`: `number`, `cursor?`: `string`, `limit?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`CastRecasterResponse`\>\> |
...
| Name | Type |
| :------ | :------ |
| `custodyAddress` | (`requestParameters`: [`UserApiCustodyAddressRequest`](../interfaces/v1.UserApiCustodyAddressRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`CustodyAddressResponse`\> |
| `recentUsers` | (`requestParameters`: [`UserApiRecentUsersRequest`](../interfaces/v1.UserApiRecentUsersRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`RecentUsersResponse`\> |
| `user` | (`requestParameters`: [`UserApiUserRequest`](../interfaces/v1.UserApiUserRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`User200Response`\> |
| `userByUsername` | (`requestParameters`: [`UserApiUserByUsernameRequest`](../interfaces/v1.UserApiUserByUsernameRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`User200Response`\> |
| `userCastLikes` | (`requestParameters`: [`UserApiUserCastLikesRequest`](../interfaces/v1.UserApiUserCastLikesRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`UserCastLikeResponse`\> |
...
| Name | Type |
| :------ | :------ |
| `custodyAddress` | (`fid`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`CustodyAddressResponse`\>\> |
| `recentUsers` | (`viewerFid?`: `number`, `cursor?`: `string`, `limit?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`RecentUsersResponse`\>\> |
| `user` | (`fid`: `number`, `viewerFid?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`User200Response`\>\> |
| `userByUsername` | (`username`: `string`, `viewerFid?`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`User200Response`\>\> |
| `userCastLikes` | (`fid`: `number`, `viewerFid?`: `number`, `limit?`: `number`, `cursor?`: `string`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`UserCastLikeResponse`\>\> |
...
| Name | Type |
| :------ | :------ |
| `userByVerification` | (`requestParameters`: [`VerificationApiUserByVerificationRequest`](../interfaces/v1.VerificationApiUserByVerificationRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`User200Response`\> |
| `verifications` | (`requestParameters`: [`VerificationApiVerificationsRequest`](../interfaces/v1.VerificationApiVerificationsRequest.md), `options?`: `AxiosRequestConfig`<`any`\>) => `AxiosPromise`<`VerificationResponse`\> |
...
| Name | Type |
| :------ | :------ |
| `userByVerification` | (`address`: `string`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`User200Response`\>\> |
| `verifications` | (`fid`: `number`, `options?`: `AxiosRequestConfig`<`any`\>) => `Promise`<(`axios?`: `AxiosInstance`, `basePath?`: `string`) => `AxiosPromise`<`VerificationResponse`\>\> |
