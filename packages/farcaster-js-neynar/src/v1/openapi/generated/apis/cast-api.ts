...
export const CastApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        casts: async (fid: number, viewerFid?: number, parentUrl?: string, cursor?: string, limit?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        recentCasts: async (viewerFid?: number, cursor?: string, limit?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CastApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async casts(fid: number, viewerFid?: number, parentUrl?: string, cursor?: string, limit?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastsResponse>> {
         ...
         * @throws {RequiredError}
         */
        async recentCasts(viewerFid?: number, cursor?: string, limit?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RecentCastsResponse>> {
...
export class CastApi extends BaseAPI {
     ...
     * @memberof CastApi
     */
    public allCastsInThread(requestParameters: CastApiAllCastsInThreadRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CastApi
     */
    public recentCasts(requestParameters: CastApiRecentCastsRequest = {}, options?: AxiosRequestConfig) {
