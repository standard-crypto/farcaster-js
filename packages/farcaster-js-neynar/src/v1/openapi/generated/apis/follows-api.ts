...
export const FollowsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        followers: async (fid: number, viewerFid?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        following: async (fid: number, viewerFid?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'fid' is not null or undefined
...
export const FollowsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async followers(fid: number, viewerFid?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FollowResponse>> {
         ...
         * @throws {RequiredError}
         */
        async following(fid: number, viewerFid?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FollowResponse>> {
...
export class FollowsApi extends BaseAPI {
     ...
     * @memberof FollowsApi
     */
    public followers(requestParameters: FollowsApiFollowersRequest, options?: AxiosRequestConfig) {
        return FollowsApiFp(this.configuration).followers(requestParameters.fid, requestParameters.viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FollowsApi
     */
    public following(requestParameters: FollowsApiFollowingRequest, options?: AxiosRequestConfig) {
        return FollowsApiFp(this.configuration).following(requestParameters.fid, requestParameters.viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
}
