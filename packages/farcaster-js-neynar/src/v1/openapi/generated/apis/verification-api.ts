...
export const VerificationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async userByVerification(address: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User200Response>> {
...
export class VerificationApi extends BaseAPI {
     ...
     */
    public userByVerification(requestParameters: VerificationApiUserByVerificationRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof VerificationApi
     */
    public verifications(requestParameters: VerificationApiVerificationsRequest, options?: AxiosRequestConfig) {
