...
export class OnChainEventsApi extends BaseAPI {
     ...
     */
    public getOnChainIdRegistrationByAddress(requestParameters: OnChainEventsApiGetOnChainIdRegistrationByAddressRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof OnChainEventsApi
     */
    public listOnChainEventsByFid(requestParameters: OnChainEventsApiListOnChainEventsByFidRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof OnChainEventsApi
     */
    public listOnChainSignersByFid(requestParameters: OnChainEventsApiListOnChainSignersByFidRequest, options?: AxiosRequestConfig) {
