 ...
 * @export
 */
export const SubmitMessageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
 ...
 * @export
 */
export const SubmitMessageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
...
export class SubmitMessageApi extends BaseAPI {
     ...
     */
    public submitMessage(requestParameters: SubmitMessageApiSubmitMessageRequest, options?: AxiosRequestConfig) {
