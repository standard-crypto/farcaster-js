...
export const UserDataApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getUserDataByFid: async (fid: number, userDataType?: UserDataType, pageSize?: number, reverse?: boolean, pageToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UserDataApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserDataByFid(fid: number, userDataType?: UserDataType, pageSize?: number, reverse?: boolean, pageToken?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetUserDataByFid200Response>> {
...
export class UserDataApi extends BaseAPI {
     ...
     */
    public getUserDataByFid(requestParameters: UserDataApiGetUserDataByFidRequest, options?: AxiosRequestConfig) {
